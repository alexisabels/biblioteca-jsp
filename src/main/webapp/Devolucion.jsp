            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card h-100 shadow">
                        <div class="card-body">
                            <h3 class="card-title text-center mb-4">Devolver</h3>
                            <form action="ControladorTest" method="post">
                                <!--si esta mal, se pone en rojo-->
                                <c:choose>
                                    <c:when test="${not empty resultadoError}">
                                        <div class="mb-3">
                                            <label for="idEjemplarDevolver" class="form-label">ID Ejemplar:</label>
                                            <input type="number"  class="form-control rojo" id="idEjemplarDevolver"
                                                name="idEjemplarDevolver"
                                    ...
                                    <c:otherwise>
                                        <div class="mb-3">
                                            <label for="idEjemplarDevolver" class="form-label">ID Ejemplar:</label>
                                            <input type="number"  class="form-control" id="idEjemplarDevolver"
                                                name="idEjemplarDevolver"
                                                placeholder="Inserta el numero de identificacion del ejemplar." required class="verde">
                                        </div>
                                    </c:otherwise>
                                </c:choose>
                                ...
                                <c:if test="${not empty resultadoError}">
                                    <div class="alert alert-danger" role="alert">
                                        Error en la solicitud de devolucion. <br>
                                ...
                                <input type="hidden" name="operacion" value="devolverLibro">
...
<!--ESTO SI VA BIEN-->
        ...
        <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js"
            integrity="sha384-oBqDVmMz9ATKxIeep9tiCxS/Z9fNfEXiDAYTujMAeBAsjFuCZSmKbSSUnQlmh/jp3"
